---
title: "Modern Web Stack Experiments"
...
**Astro**
My current favourite for most sites. It outputs static HTML by default, only adds JavaScript when you actually need it, and works brilliantly with content stored in markdown or a headless CMS. This site is built with Astro.

**Tailwind CSS**
Utility-first CSS that I resisted for ages and now can't imagine working without. It's not for everyone, but for rapid development with consistent design systems, it's excellent.
